...
INSERT INTO category (name, description,image_url,is_active) VALUES ('Movies', 'This is description for Movies category!', 'CAT_2.png', true);
...
VALUES ('Virat', 'Kohli', 'ADMIN', true, '$2b$10$vWla/TmGQrCTlfgJIzOO3eGJCbhdJEGry1eDlpYnSip7FmsGaYLpW', 'vk@gmail.com', '8888888888');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Ravindra', 'Jadeja', 'SUPPLIER', true, '$2b$10$d.e9X3St5auN8QC9rWYXBueYezFExV0A4aDxU1phoPE0SVO5Sde8O', 'rj@gmail.com', '9999999999');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Ravichandra', 'Ashwin', 'SUPPLIER', true, '$2b$10$T3uYs32jDBLmngsnX4fxb.QJ0Xng92DRV4QCIAlJFPwL4DKOwS0L2', 'ra@gmail.com', '7777777777');
INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Shivam', 'Chaube', 'USER', true, '$2b$10$e4C1pn7C.WZcp8t1EQ7F3u4Ie45EqLLAJc0sgv567c1maERIZNI7K', 'skc@gmail.com', '9969770027');
