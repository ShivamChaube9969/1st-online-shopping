...
@Service("cartService") // it is used at the service layer whereas repository is
						// used at the
// persistent layer so if any business logic we need to implement we
// can do with service layer
